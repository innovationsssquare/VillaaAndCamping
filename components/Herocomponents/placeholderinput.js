...
export function PlaceholdersAndVanishInput({
  ...
  }, [placeholders, handleVisibilityChange]) // Added handleVisibilityChange to dependencies
  ...
  return (
    ...
    >
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-white/10 bg-white/20 dark:bg-zinc-700/50 dark:disabled:bg-zinc-800/30 transition duration-200 flex items-center justify-center"
      >
        <motion.svg
          ...
          className="text-white/70 h-4 w-4"
        >
